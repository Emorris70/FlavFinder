...
- [X] Implement project structure and dependencies.
- [X] Add link to list of indie project in student repo.
- [x] Complete Weekly log

### Week 3 

- [X] Layout and execute file structure
- [X] Create sign up and login JSP pages.
- [X] Get a better understanding of JUint explore Juipter/Vintage
- [x] Complete Weekly log
- [X] Complete Indie checkpoint 1
